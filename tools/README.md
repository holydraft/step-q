...
- `validate_mappings.py`: generic validator that discovers all `mappings/*/mapping.yaml` libraries.
- `mappings/orderspot/validate.py`: Orderspot-specific source existence and collision checks.
